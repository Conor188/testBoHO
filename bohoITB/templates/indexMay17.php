...
<body>	  
 ...
 <div class="col-lg-12">
    ...
    <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner text-top "role="listbox">
            <div class="carousel-item active">
              <img class="d-block w-100 img-fluid" src="../images/carousel1.jpg" alt="First slide">
			 <div class="carousel-caption d-none d-md-block">
        <h1>Welcome to Bohemia Website</h1>
        <p>The home of Bohemian Fashion </p>
      </div>
			  
            </div>
            <div class="carousel-item">
              <img class="d-block w-100 img-fluid" src="../images/carousel2.jpg" alt="Second slide">
			  	 <div class="carousel-caption d-none d-md-block">
        ...
        <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
            ...
            <div class="carousel-item">
              <img class="d-block w-100 img-fluid" src="../images/carousel3.jpg"alt="Third slide">
			  	 <div class="carousel-caption caption-center d-none d-md-block justify-content-center">
        <h1>First slide label</h1>
        <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
      </div>
            </div>
			<div class="carousel-item">
              <img class="d-block w-100 img-fluid" src="../images/carousel9.jpg"alt="Third slide">
			  	 <div class="carousel-caption d-none d-md-block">
        <h1>First slide label</h1>
        <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
      </div>
