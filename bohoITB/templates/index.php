    ...
    <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="../images/test66.jpg" alt="First slide">
            ...
            <div class="carousel-item">
              <img class="d-block img-fluid" src="../images/boho210.jpg" alt="Second slide">
			  	   <div class="carousel-caption d-none d-md-block">
					<h1>Bohemia</h1>
						<p>The home of Bohemian Fashion.</p>
					</div>
			...
			<div class="carousel-item">
              <img class="d-block img-fluid" src="../images/boho986.jpg"alt="Third slide">
			  	   <div class="carousel-caption d-none d-md-block">
						<h1>Bohemia</h1>
							<p>The home of Bohemian Fashion.</p>
					</div>
...
<div class="row">
          ...
          <div class="col-lg-3 col-md-6 mb-3">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
                  <a role="button" class="btn btn-lg btn-block btn-secondary"  href="index.php?action=shirt">Tops</button></a>
		...
		<div class="col-lg-3 col-md-6 mb-3">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
				 <a role="button" class="btn btn-lg btn-block btn-secondary"  href="index.php?action=trouser">Jeans</button></a>
                </h4>
